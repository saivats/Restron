...
class Restaurant(Base):
    ...
    plan_set_by = Column(String, default="system")
    plan_expires_at = Column(DateTime, nullable=True)
    is_active = Column(Boolean, default=True, nullable=False)
    growth_preview_used = Column(Boolean, default=False)
    growth_preview_expires_at = Column(DateTime, nullable=True)
    upi_id = Column(String, default="")
    menu_pdf_url = Column(String, default="")
    auto_print_kot = Column(Boolean, default=False)
